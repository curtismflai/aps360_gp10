...
class Enhancer(nn.Module):
    def __init__(self, name):
        ...
        self.name = name
        self.enhancer = nn.Sequential(nn.Conv2d(in_channels=3, out_channels=128, kernel_size=9, padding=4),
                                      nn.LeakyReLU(0.2, inplace=True),
                                      nn.Conv2d(in_channels=128, out_channels=64, kernel_size=7, padding=3),
                                      nn.LeakyReLU(0.2, inplace=True),
...
class Discriminator(nn.Module):
    def __init__(self, name):
        ...
        self.name = name
        self.discriminator = nn.Sequential(nn.Conv2d(in_channels=3, out_channels=128, kernel_size=9, padding=4),
                                          nn.LeakyReLU(0.2, inplace=True),
                                          nn.Conv2d(in_channels=128, out_channels=1, kernel_size=5, padding=2),
                                          )
